...
<head>
    ...
    <script src="../cdn-cgi/apps/head/2oc_RD5SS6wgN5SiQnSEnWVNHg8.js">

    </script>
    <link
        href="{{asset("five/css/css2.css?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Poppins:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap")}}"
        rel="stylesheet">

    <link rel="stylesheet" href="{{asset("five/vendors/fontawesome-pro-5/css/all.css")}}">
    <link rel="stylesheet" href="{{asset("five/vendors/bootstrap-select/css/bootstrap-select.min.css")}}">
    <link rel="stylesheet" href="{{asset("five/vendors/slick/slick.min.css")}}">
    <link rel="stylesheet" href="{{asset("five/vendors/magnific-popup/magnific-popup.min.css")}}">
    <link rel="stylesheet" href="{{asset("five/vendors/jquery-ui/jquery-ui.min.css")}}">
    <link rel="stylesheet" href="{{asset("five/vendors/chartjs/Chart.min.css")}}">
    <link rel="stylesheet" href="{{asset("five/vendors/dropzone/css/dropzone.min.css")}}">
    <link rel="stylesheet" href="{{asset("five/vendors/animate.css")}}">
    <link rel="stylesheet" href="{{asset("five/vendors/timepicker/bootstrap-timepicker.min.css")}}">
    <link rel="stylesheet" href="{{asset("five/vendors/mapbox-gl/mapbox-gl.min.css")}}">
    <link rel="stylesheet" href="{{asset("five/vendors/dataTables/jquery.dataTables.min.css")}}">

    <link rel="stylesheet" href="{{asset("five/css/themes.css")}}">

    <link rel="icon" href="{{asset("five/images/favicon.ico")}}">
...
@include('Home.v5.Header')

<main id="content">
    <section class="d-flex flex-column">
        <div style="background-image: url('five/images/bg-home-01.jpg')"
                    ...
                    <div class="bg-white px-6 rounded-bottom rounded-top-right pb-6 pb-lg-0">
                        <div class="row align-items-center" id="accordion-4">
                            <div class="col-md-6 col-lg-3 col-xl-3 pt-6 pt-lg-0 order-1">
                                <label class="text-uppercase font-weight-500 letter-spacing-093 mb-1"> @lang('messages.PropertyList')</label>
                                <select
                                    class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
                                    title=" @lang('messages.PropertyList')" data-style="p-0 h-24 lh-17 text-dark" name="type">

                                </select>
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-5 pt-6 pt-lg-0 order-2">
                                <label
                                    class="text-uppercase font-weight-500 letter-spacing-093">@lang('messages.Search')</label>
                            ...
                            <div id="advanced-search-filters-4" class="col-12 pt-4 pb-sm-4 order-sm-5 order-4 collapse"
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-lg-3 pt-6">
                                        <label
                                            class="text-uppercase font-weight-500 letter-spacing-093 mb-1">
                                            @lang('messages.beds')</label>
                                        <select
                                            class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
                                            name="bedroom" title="@lang('messages.beds')" data-style="p-0 h-24 lh-17 text-dark">
                                            <option>@lang('messages.beds')</option>
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
                                    ...
                                    <div class="col-sm-6 col-lg-3 pt-6">
                                        <label
                                            class="text-uppercase font-weight-500 letter-spacing-093 mb-1">@lang('messages.beds')</label>
                                        <select
                                            class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
                                            title="  @lang('messages.beds')" data-style="p-0 h-24 lh-17 text-dark" name="bathroom">
                                            <option>@lang('messages.beds')</option>
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                                    ...
                                    <div class="col-sm-6 col-lg-3 pt-6">
                                        <label class="text-uppercase font-weight-500 letter-spacing-093 mb-1">
                                            @lang('messages.AllCategories')

                                        </label>
                                        <select
                                            class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
                                            name=" @lang('messages.AllCategories')" title="@lang('messages.AllCategories')" data-style="p-0 h-24 lh-17 text-dark">
                                            <option> @lang('messages.AllCategories')</option>
                                    ...
                                    <div class="col-sm-6 col-lg-3 pt-6">
                                        ...
                                        <select
                                            class="form-control selectpicker bg-transparent border-bottom rounded-0 border-color-input"
                                            name="areas" title="@lang('messages.Area')" data-style="p-0 h-24 lh-17 text-dark">
                                            <option> @lang('messages.Area')</option>
                                ...
                                <div class="row pt-2">
                                    <div class="col-md-6 col-lg-4 pt-6 slider-range slider-range-secondary">
                                        <label for="price-1-4" class="mb-4 text-gray-light">@lang('messages.Price')</label>
                                    ...
                                    <div class="col-md-6 col-lg-4 pt-6 slider-range slider-range-secondary">
                                        <label for="area-size-4" class="mb-4 text-gray-light">@lang('messages.Area')</label>
                                        <div data-slider="true"
                                    ...
                                    <div class="col-sm-6 col-lg-3 pt-6">
                                        <label class="text-uppercase font-weight-500 letter-spacing-093 mb-1">@lang('messages.PropertyID')</label>
                                        <input type="text" name="search"
                                               ...
                                               placeholder="@lang('messages.PropertyID')">
                                    </div>
                    ...
                    <div class="box pb-7 pt-2">
                        <div class="card shadow-hover-2" data-animate="zoomIn">
                            <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top">
                             {{--   <img src="five/images/properties-grid-02.jpg" alt="Home in Metric Way">--}}
                                {{\App\Helpers\Helper::GetImageEstate($itemestate->id)}}
                                <div class="card-img-overlay p-2 d-flex flex-column">
                                    <div>
                                        <span class="badge mr-2 badge-orange">
                                            @lang('messages.Sponsored')
                                        </span>
                            ...
                            <div class="card-body pt-3">
                                ...
                                <ul class="list-inline d-flex mb-0 flex-wrap mr-n5">
                                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5"
                                        data-toggle="tooltip" title="{{$itemestate->RoomNumber}} @lang('messages.beds')">
                                        <svg class="icon icon-bedroom fs-18 text-primary mr-1">
                                            <use xlink:href="#icon-bedroom"></use>
                                        </svg>
                                        {{$itemestate->RoomNumber}} @lang('messages.beds')
                                    </li>
                                    ...
                                    <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-5"
                                        ...
                                        {{$itemestate->LandTotalSquare}}   @lang('messages.Ft')
                                    </li>
            ...
            <div class="container container-xxl">
                <div class="row">
                    <div class="col-lg-4 pr-xl-13" data-animate="fadeInLeft">
                        <h2 class="text-heading lh-1625"> @lang('messages.FeaturedProperty') <br>

                        </h2>
                        <span class="heading-divider"></span>

                        <a href="listing-grid-with-left-filter.html" class="btn btn-lg text-secondary btn-accent">
                            <i class="far fa-long-arrow-right ml-1"></i>
                        </a>
                    </div>
                            ...
                            <div class="box px-0 py-6">
                                <a href="listing-grid-with-left-filter.html"
                                   class="card border-0 align-items-center justify-content-center pt-7 pb-5 px-3 shadow-hover-3 bg-transparent bg-hover-white text-decoration-none">
                                    <img src="five/images/verified.png" class="card-img-top" alt="Apartment">
                                    <div class="card-body px-0 pt-5 pb-0">
                                        <h4 class="card-title fs-16 lh-2 text-dark mb-0">@lang('messages.Appertment')</h4>
                                    </div>
                                </a>
                            </div>
                            <div class="box px-0 py-6">
                                <a href="listing-grid-with-left-filter.html"
                                   class="card border-0 align-items-center justify-content-center pt-7 pb-5 px-3 shadow-hover-3 bg-transparent bg-hover-white text-decoration-none">
                                    <img src="five/images/sofa.png" class="card-img-top" alt="House">
                                    <div class="card-body px-0 pt-5 pb-0">
                                        <h4 class="card-title fs-16 lh-2 text-dark mb-0">@lang('messages.House')</h4>
                                    </div>
                                </a>
                            </div>
                            <div class="box px-0 py-6">
                                <a href="listing-grid-with-left-filter.html"
                                   class="card border-0 align-items-center justify-content-center pt-7 pb-5 px-3 shadow-hover-3 bg-transparent bg-hover-white text-decoration-none">
                                    <img src="five/images/architecture-and-city.png" class="card-img-top" alt="Office">
                                    <div class="card-body px-0 pt-5 pb-0">
                                        <h4 class="card-title fs-16 lh-2 text-dark mb-0">@lang('messages.Office')</h4>
                                    </div>
                                </a>
                            </div>
                            <div class="box px-0 py-6">
                                <a href="listing-grid-with-left-filter.html"
                                   class="card border-0 align-items-center justify-content-center pt-7 pb-5 px-3 shadow-hover-3 bg-transparent bg-hover-white text-decoration-none">
                                    <img src="five/images/eco-house.png" class="card-img-top" alt="Villa">
                                    <div class="card-body px-0 pt-5 pb-0">
                                        <h4 class="card-title fs-16 lh-2 text-dark mb-0">@lang('messages.villa')</h4>
                                    </div>
                                </a>
                            </div>
                            <div class="box px-0 py-6">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 pr-xl-8 pb-lg-0 pb-6" data-animate="fadeInLeft">
                        <a href="#" class="hover-shine d-block">
                            <img src="five/images/single-image-01.jpg" class="rounded-lg w-100"
                    ...
                    <div class="col-lg-6 pl-xl-8" data-animate="fadeInRight">
                        ...
                        <div class="input-group input-group-lg pr-sm-17">
                            <input type="text"
                                   ...
                                   name="search" placeholder="@lang('messages.Finding')">
    ...
    <section class="pt-lg-12 pb-lg-15 py-11">
        <div class="container container-xxl">
            <h2 class="text-heading text-center">
                @lang('messages.pouplar')
            </h2>
            <span class="heading-divider text-center"></span>
            ...
            <div class="slick-slider mx-n2"
                ...
                <div class="box px-2" data-animate="fadeInUp">
                    <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                        <img src="five/images/properties-city-01.jpg" class="card-img" alt="New York">
                ...
                <div class="box px-2" data-animate="fadeInUp">
                    <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                        <img src="five/images/properties-city-02.jpg" class="card-img" alt="Los Angeles">
                        <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                            <h2 class="card-title mb-0 fs-20 lh-182"><a href="single-property-1.html"
                                                                        class="text-white">
                                    @lang('messages.Sulaymaniyah')
                                </a></h2>
                ...
                <div class="box px-2" data-animate="fadeInUp">
                    <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                        <img src="five/images/properties-city-03.jpg" class="card-img" alt="San Jose">
                        <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                            <h2 class="card-title mb-0 fs-20 lh-182"><a href="single-property-1.html"
                                                                        class="text-white">
                                    @lang('messages.Sulaymaniyah')
                ...
                <div class="box px-2" data-animate="fadeInUp">
                    <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                        <img src="five/images/properties-city-04.jpg" class="card-img" alt="Fort Worth">
                        <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                            <h2 class="card-title mb-0 fs-20 lh-182"><a href="single-property-1.html"
                                                                        class="text-white">
                                    @lang('messages.Baghdad')
                                </a></h2>
                ...
                <div class="box px-2" data-animate="fadeInUp">
                    <div class="card text-white bg-overlay-gradient-8 hover-zoom-in">
                        <img src="five/images/properties-city-05.jpg" class="card-img" alt="Kansas City">
                        <div class="card-img-overlay d-flex justify-content-end flex-column p-4">
                            <h2 class="card-title mb-0 fs-20 lh-182"><a href="single-property-1.html"
                                                                        class="text-white">
                                    @lang('messages.Karbala')
                                </a></h2>
        ...
        <div class="list-group list-group-no-border bg-dark py-3">
            ...
            <div class="list-group-item card bg-transparent">
                <div class="position-relative hover-change-image bg-hover-overlay">
                    <img src="five/images/compare-01.jpg" class="card-img" alt="properties">
            ...
            <div class="list-group-item card bg-transparent">
                <div class="position-relative hover-change-image bg-hover-overlay">
                    <img src="five/images/compare-02.jpg" class="card-img" alt="properties">
                    <div class="card-img-overlay">
                        <a href="#" class="text-white hover-image fs-16 lh-1 pos-fixed-top-right position-absolute m-2"><i
                                class="fal fa-minus-circle"></i></a>
                    </div>
            ...
            <div class="list-group-item card card bg-transparent">
                <div class="position-relative hover-change-image bg-hover-overlay ">
                    <img src="five/images/compare-03.jpg" class="card-img" alt="properties">
                    <div class="card-img-overlay">
                        <a href="#" class="text-white hover-image fs-16 lh-1 pos-fixed-top-right position-absolute m-2"><i
                                class="fal fa-minus-circle"></i></a>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                <a class="d-block mb-2" href="#">
                    <img src="five/images/logo-white-primary.png" alt="koshkizinwe">
                </a>
                <div class="lh-26 font-weight-500">
                    ...
                    <a class="d-block text-muted hover-white" href="index.htm">
                        koshkizinwe.com
                    </a>
                </div>
            </div>
            <div class="col-md-6 col-lg-2 mb-6 mb-md-0">
                <h4 class="text-white fs-16 my-4 font-weight-500">@lang('messages.Important')</h4>
                <ul class="list-group list-group-flush list-group-no-border">
                    <li class="list-group-item bg-transparent p-0">
                        <a href="#" class="text-muted lh-26 font-weight-500 hover-white">@lang('messages.menu2')</a>
                    </li>
                    <li class="list-group-item bg-transparent p-0">
            ...
            <div class="col-md-6 col-lg-2 mb-6 mb-md-0">
                <h4 class="text-white fs-16 my-4 font-weight-500">@lang('messages.Support')</h4>
                <ul class="list-group list-group-flush list-group-no-border">
                    <li class="list-group-item bg-transparent p-0">
                        <a href="#" class="text-muted lh-26 font-weight-500 hover-white">@lang('messages.Support')</a>
                    </li>
...
<script src="{{asset("five/vendors/jquery.min.js")}}"></script>
<script src="{{asset("five/vendors/jquery-ui/jquery-ui.min.js")}}"></script>
<script src="{{asset("five/vendors/bootstrap/bootstrap.bundle.js")}}"></script>
<script src="{{asset("five/vendors/bootstrap-select/js/bootstrap-select.min.js")}}"></script>
<script src="{{asset("five/vendors/slick/slick.min.js")}}"></script>
<script src="{{asset("five/vendors/waypoints/jquery.waypoints.min.js")}}"></script>
<script src="{{asset("five/vendors/counter/countUp.js")}}"></script>
<script src="{{asset("five/vendors/magnific-popup/jquery.magnific-popup.min.js")}}"></script>
<script src="{{asset("five/vendors/chartjs/Chart.min.js")}}"></script>
<script src="{{asset("five/vendors/dropzone/js/dropzone.min.js")}}"></script>
<script src="{{asset("five/vendors/timepicker/bootstrap-timepicker.min.js")}}"></script>
<script src="{{asset("five/vendors/hc-sticky/hc-sticky.min.js")}}"></script>
<script src="{{asset("five/vendors/jparallax/TweenMax.min.js")}}"></script>
<script src="{{asset("five/vendors/mapbox-gl/mapbox-gl.js")}}"></script>
<script src="{{asset("five/vendors/dataTables/jquery.dataTables.min.js")}}"></script>

<script src="{{asset("five/js/theme.js")}}"></script>
...
<i class="far fa-eye-slash"></i>
                            ...
                            <div class="d-flex p-2 border re-capchar align-items-center mb-4">
                                ...
                                <a href="#" class="d-inline-block ml-auto">
                                    <img src="five/images/re-captcha.png" alt="Re-capcha">
                                </a>
                            </div>
                        ...
                        <div class="row no-gutters mx-n2">
                            ...
                            <div class="col-4 px-2 mb-4">
                                <a href="#" class="btn btn-lg btn-block google px-0">
                                    <img src="five/images/google.png" alt="Google">
                                </a>
                            </div>
                            <div class="col-4 px-2 mb-4">
