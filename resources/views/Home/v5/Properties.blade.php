...
<head>
    ...
    <title>Listing Grid With Right Filter - HomeID</title>

    <script src="../cdn-cgi/apps/head/2oc_RD5SS6wgN5SiQnSEnWVNHg8.js"></script><link href="../css2.css?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Poppins:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet">
    ...
    <meta name="twitter:title" content="Listing Grid With Right Filter">
    <meta name="twitter:description" content="Real Estate Html Template">
    <meta name="twitter:image" content="images/homeid-social-logo.png">

    <meta property="og:url" content="listing-grid-with-right-filter.html">
    <meta property="og:title" content="Listing Grid With Right Filter">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg px-0">
                <a class="navbar-brand" href="index.html">
                    <img src="/five/images/logo.png" alt="HomeID" class="d-none d-lg-inline-block">
                    <img src="/five/images/logo-white.png" alt="HomeID" class="d-inline-block d-lg-none">
                </a>
                ...
                <div class="col-lg-8 mb-8 mb-lg-0">
                        ...
                        <div class="col-md-6 mt-6 mt-md-0">
                            <div class="d-flex justify-content-md-end align-items-center">
                                ...
                                <div class="d-none d-md-block">
                                    <a class="fs-sm-18 text-dark opacity-2" href="{{url('v5/EstateProperties/'.$type)}}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-6">
                            <div class="card border-0" data-animate="fadeInUp">
                                <div class="position-relative hover-change-image bg-hover-overlay rounded-lg card-img">
                                    <img src="/five/images/properties-grid-35.jpg" alt="Home in Metric Way">
                        ...
                        <div class="col-md-6 mb-6">
                            <div class="card border-0" data-animate="fadeInUp">
                                <div class="position-relative hover-change-image bg-hover-overlay rounded-lg card-img">
                                    <img src="/five/images/properties-grid-36.jpg" alt="Home in Metric Way">
                                    <div class="card-img-overlay d-flex flex-column">
                        ...
                        <div class="col-md-6 mb-6">
                            <div class="card border-0" data-animate="fadeInUp">
                                <div class="position-relative hover-change-image bg-hover-overlay rounded-lg card-img">
                                    <img src="/five/images/properties-grid-37.jpg" alt="Home in Metric Way">
                                    <div class="card-img-overlay d-flex flex-column">
                                        <div><span class="badge badge-primary">For Sale</span></div>
                                        <div class="mt-auto d-flex hover-image">
                                            <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                        ...
                        <div class="col-md-6 mb-6">
                            <div class="card border-0" data-animate="fadeInUp">
                                <div class="position-relative hover-change-image bg-hover-overlay rounded-lg card-img">
                                    <img src="/five/images/properties-grid-73.jpg" alt="Home in Metric Way">
                                    <div class="card-img-overlay d-flex flex-column">
                                        <div><span class="badge badge-primary">For Sale</span></div>
                                        <div class="mt-auto d-flex hover-image">
                                            <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                        ...
                        <div class="col-md-6 mb-6">
                            <div class="card border-0" data-animate="fadeInUp">
                                <div class="position-relative hover-change-image bg-hover-overlay rounded-lg card-img">
                                    <img src="/five/images/properties-grid-67.jpg" alt="Home in Metric Way">
                                    <div class="card-img-overlay d-flex flex-column">
                                        <div><span class="badge badge-primary">For Sale</span></div>
                                        <div class="mt-auto d-flex hover-image">
                                            <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                        ...
                        <div class="col-md-6 mb-6">
                            <div class="card border-0" data-animate="fadeInUp">
                                <div class="position-relative hover-change-image bg-hover-overlay rounded-lg card-img">
                                    <img src="/five/images/properties-grid-68.jpg" alt="Home in Metric Way">
                                    <div class="card-img-overlay d-flex flex-column">
                                        <div><span class="badge badge-indigo">for Rent</span></div>
                                        <div class="mt-auto d-flex hover-image">
                                            <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                        ...
                        <div class="col-md-6 mb-6">
                            <div class="card border-0" data-animate="fadeInUp">
                                <div class="position-relative hover-change-image bg-hover-overlay rounded-lg card-img">
                                    <img src="/five/images/properties-grid-69.jpg" alt="Home in Metric Way">
                                    <div class="card-img-overlay d-flex flex-column">
                                        <div><span class="badge badge-primary">For Sale</span></div>
                                        <div class="mt-auto d-flex hover-image">
                                            <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                        ...
                        <div class="col-md-6 mb-6">
                            <div class="card border-0" data-animate="fadeInUp">
                                <div class="position-relative hover-change-image bg-hover-overlay rounded-lg card-img">
                                    <img src="/five/images/properties-grid-70.jpg" alt="Home in Metric Way">
                                    <div class="card-img-overlay d-flex flex-column">
                                        <div><span class="badge badge-indigo">for Rent</span></div>
                                        <div class="mt-auto d-flex hover-image">
                                            <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                        ...
                        <div class="col-md-6 mb-6">
                            <div class="card border-0" data-animate="fadeInUp">
                                <div class="position-relative hover-change-image bg-hover-overlay rounded-lg card-img">
                                    <img src="/five/images/properties-grid-71.jpg" alt="Home in Metric Way">
                                    <div class="card-img-overlay d-flex flex-column">
                                        <div><span class="badge badge-primary">For Sale</span></div>
                                        <div class="mt-auto d-flex hover-image">
                                            <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                        ...
                        <div class="col-md-6 mb-6">
                            <div class="card border-0" data-animate="fadeInUp">
                                <div class="position-relative hover-change-image bg-hover-overlay rounded-lg card-img">
                                    <img src="/five/images/properties-grid-72.jpg" alt="Home in Metric Way">
                                    <div class="card-img-overlay d-flex flex-column">
                                        <div><span class="badge badge-primary">For Sale</span></div>
                                        <div class="mt-auto d-flex hover-image">
                                            <ul class="list-inline mb-0 d-flex align-items-end mr-auto">
                            ...
                            <div class="card-body pl-0 pl-lg-6 pr-0 pt-2 pb-4">
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg border-0 shadow-none" id="key-word" placeholder="Enter keyword...">
                                    </div>
                                    <div class="form-group">
                                        <label for="location" class="sr-only">Location</label>
                                        <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Location" data-style="btn-lg py-2 h-52" id="location">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="All Types" data-style="btn-lg py-2 h-52" id="type">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="All Status" data-style="btn-lg py-2 h-52" id="status">
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="col">
                                            ...
                                            <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Beds" data-style="btn-lg py-2 h-52" id="bed">
                                                <option>3</option>
                                                <option>4</option>
                                            </select>
                                        </div>
                                        <div class="col">
                                            ...
                                            <select class="form-control border-0 shadow-none form-control-lg selectpicker" title="Baths" data-style="btn-lg py-2 h-52" id="baths">
                                                <option>3</option>
                                                <option>4</option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group slider-range slider-range-secondary">
                                        ...
                                        <div class="text-center mt-2">
                                            <input id="area-size" type="text" readonly="" class="border-0 amount text-center text-body font-weight-500">
                                        </div>
                                    </div>
                                ...
                                <div class="slick-slider mx-0" data-slick-options='{"slidesToShow": 1, "autoplay":true}'>
                                    <div class="box px-0">
                                        <div class="card border-0">
                                            <img src="/five/images/feature-property-01.jpg" class="card-img" alt="Villa on Hollywood Boulevard">
                            ...
                            <div class="card-body pl-0 pl-lg-6 pr-0 py-0">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item px-0 pb-3 pt-0">
                                        <div class="media align-items-center">
                                            <a href="agent-details-1.html" class="d-block w-60px h-60 mr-3">
                                                <img src="/five/images/agent-2.jpg" class="rounded-circle" alt="agent">
                                            </a>
                                    ...
                                    <li class="list-group-item px-0 pt-2 pb-3">
                                        <div class="media align-items-center">
                                            <a href="agent-details-1.html" class="d-block w-60px h-60 mr-3">
                                                <img src="/five/images/agent-1.jpg" class="rounded-circle" alt="agent">
                                            </a>
                                            <div class="media-body">
                                    ...
                                    <li class="list-group-item px-0 pt-2">
                                        <div class="media align-items-center">
                                            <a href="agent-details-1.html" class="d-block w-60px h-60 mr-3">
                                                <img src="/five/images/agent-3.jpg" class="rounded-circle" alt="agent">
                                            </a>
                                            <div class="media-body">
                                                <a href="agent-details-1.html" class="d-block text-dark font-weight-500 lh-15 hover-primary">Hana
                                                    Garcia</a>
                                                <p class="mb-0 fs-13 mb-0 lh-17">Real estate broker</p>
                                                <p class="mb-0 fs-13 mb-0 lh-17"><span>(+123)</span><span class="text-heading d-inline-block ml-2">1900 68668</span>
                                                </p>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-6 mb-md-0">
                <a class="d-block mb-2" href="#">
                    <img src="/five/images/logo-white-primary.png" alt="HomeID">
                </a>
                <div class="lh-26 font-weight-500">
                    ...
                    <a class="d-block text-lighter font-weight-bold fs-15 hover-white" href="tel:(+68)122109876">(+68)1221
                        09876</a>
                    <a class="d-block text-muted hover-white" href="index.htm">www.homeid.com</a>
                </div>
            </div>
