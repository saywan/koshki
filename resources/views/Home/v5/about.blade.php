...
<head>
    ...
    <link href="{{asset("five/css/css2.css?family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Poppins:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap")}}" rel="stylesheet">
            ...
            <nav class="navbar navbar-expand-lg px-0">
                ...
                <div class="collapse navbar-collapse mt-3 mt-lg-0 mx-auto flex-grow-0" id="primaryMenu01">
                    <ul class="navbar-nav hover-menu main-menu px-0 mx-lg-n4">
                        ...
                        <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4">
                            <a class="nav-link  p-0" href="{{url('v5/EstateRequest')}}" >
                                @lang('messages.menu6')
                        ...
                        <li id="navbar-item-home" aria-haspopup="true" aria-expanded="false" class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4">
                            <a class="nav-link  p-0" href="{{url('v5/')}}" >
                                @lang('messages.menu2')
...
<main id="content">
    <section class="pb-6 page-title shadow">
        <div class="container">
            ...
            <h1 class="fs-30 lh-16 mb-1 text-dark font-weight-600">@lang('messages.menu4') </h1>
        </div>
    </section>
