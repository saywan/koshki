...
<head>
    ...
    <link rel="stylesheet" href="{{asset("stylethree/css/responsive.css")}}">
    <!-- Title -->
    <title>
        koshki Real Estate
    </title>
        ...
        <div class="container-fluid p0">
            ...
            <nav>
                ...
                <div class="menu-toggle">
                    <img class="nav_logo_img img-fluid" src="/stylethree/images/header-logo.png" alt="header-logo.png">
                ...
                <a href="#" class="navbar_brand float-left dn-smd">
                    <img class="logo1 img-fluid" src="/stylethree/images/header-logo2.png" alt="header-logo.png">
                    <img class="logo2 img-fluid" src="/stylethree/images/header-logo2.png" alt="header-logo2.png">
                    <span>koshkizinwe</span>
                </a>
                        ...
                        <div class="row mt25 tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="col-lg-6 col-xl-6">
                                <div class="login_thumb">
                                    <img class="img-fluid w100" src="/stylethree/images/resource/login.jpg" alt="login.jpg">
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-6">
                        ...
                        <div class="row mt25 tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="col-lg-6 col-xl-6">
                                <div class="regstr_thumb">
                                    <img class="img-fluid w100" src="/stylethree/images/resource/regstr.jpg" alt="regstr.jpg">
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-6">
        ...
        <div class="mobile-menu">
            <div class="header stylehome1">
                <div class="main_logo_home2 text-center">
                    <img class="nav_logo_img img-fluid mt20" src="/stylethree/images/header-logo2.png" alt="header-logo2.png">
                            ...
                            <div class="sidebar_listing_list style2 mobile_sytle_sidebar mb0">
                                <div class="sidebar_advanced_search_widget">
                                    <h4 class="mb25">
                                        ...
                                        <a class="filter_closed_btn float-right" href="#"><small>Hide Filter</small> <span class="flaticon-close"></span></a></h4>
                ...
                <div class="col-lg-6">
                    <div class="breadcrumb_content style2 mb0-991">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-thm" aria-current="page">  @lang('messages.PropertyList')</li>
                        </ol>
                        <h2 class="breadcrumb_title">
                            @lang('messages.PropertyList')
                        </h2>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-md-12 col-lg-12">
                    ...
                    <div class="row">
                                ...
                                <div class="details">
                                    ...
                                    <div class="fp_footer">
                                        <ul class="fp_meta float-left mb0">
                                            <li class="list-inline-item"><a href="#"><img src="/stylethree/images/property/pposter1.png" alt="pposter1.png"></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="feat_property list">
                                <div class="thumb">
                                    <img class="img-whp" src="/stylethree/images/property/fp3.jpg" alt="fp3.jpg">
                                    <div class="thmb_cntnt">
                                        <ul class="icon mb0">
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-transfer-1"></span></a></li>
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-heart"></span></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="feat_property list">
                                <div class="thumb">
                                    <img class="img-whp" src="/stylethree/images/property/fp2.jpg" alt="fp2.jpg">
                                    <div class="thmb_cntnt">
                                        <ul class="icon mb0">
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-transfer-1"></span></a></li>
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-heart"></span></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="feat_property list">
                                <div class="thumb">
                                    <img class="img-whp" src="/stylethree/images/property/fp15.jpg" alt="fp15.jpg">
                                    <div class="thmb_cntnt">
                                        <ul class="icon mb0">
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-transfer-1"></span></a></li>
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-heart"></span></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="feat_property list">
                                <div class="thumb">
                                    <img class="img-whp" src="/stylethree/images/property/fp16.jpg" alt="fp16.jpg">
                                    <div class="thmb_cntnt">
                                        <ul class="icon mb0">
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-transfer-1"></span></a></li>
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-heart"></span></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="feat_property list">
                                <div class="thumb">
                                    <img class="img-whp" src="/stylethree/images/property/fp17.jpg" alt="fp17.jpg">
                                    <div class="thmb_cntnt">
                                        <ul class="icon mb0">
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-transfer-1"></span></a></li>
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-heart"></span></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="feat_property list">
                                <div class="thumb">
                                    <img class="img-whp" src="/stylethree/images/property/fp18.jpg" alt="fp18.jpg">
                                    <div class="thmb_cntnt">
                                        <ul class="icon mb0">
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-transfer-1"></span></a></li>
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-heart"></span></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="feat_property list">
                                <div class="thumb">
                                    <img class="img-whp" src="/stylethree/images/property/fp19.jpg" alt="fp19.jpg">
                                    <div class="thmb_cntnt">
                                        <ul class="icon mb0">
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-transfer-1"></span></a></li>
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-heart"></span></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="feat_property list">
                                <div class="thumb">
                                    <img class="img-whp" src="/stylethree/images/property/fp20.jpg" alt="fp20.jpg">
                                    <div class="thmb_cntnt">
                                        <ul class="icon mb0">
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-transfer-1"></span></a></li>
                                            <li class="list-inline-item"><a href="#"><span class="flaticon-heart"></span></a></li>
...
<script type="text/javascript" src="{{asset("stylethree/js/progressbar.js")}}"></script>
