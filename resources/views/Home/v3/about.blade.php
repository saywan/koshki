                        ...
                        <div class="row mt25 tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="col-lg-6 col-xl-6">
                                <div class="login_thumb">
                                    <img class="img-fluid w100" src="{{asset("Content/images/resource/login.jpg")}}" alt="login.jpg">
                                </div>
                        ...
                        <div class="row mt25 tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="col-lg-6 col-xl-6">
                                <div class="regstr_thumb">
                                    <img class="img-fluid w100" src="{{asset("Content/images/resource/regstr.jpg")}}" alt="regstr.jpg">
        ...
        <div class="mobile-menu">
            <div class="header stylehome1">
                <div class="main_logo_home2 text-center">
                    <img class="nav_logo_img img-fluid mt20" src="/Content/images/header-logo2.png" alt="header-logo2.png">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xl-5">
                    <div class="about_thumb">
                        <img class="img-fluid w100" src="{{asset("Content/images/about/1.jpg")}}" alt="1.jpg">
