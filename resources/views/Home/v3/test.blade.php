...
<head>
    ...
    <meta name="keywords" content="Koshki">
    ...
    <link rel="stylesheet" href="/public/Content/css/style.css">
    <!-- Responsive stylesheet -->
    <link rel="stylesheet" href="/public/Content/css/responsive.css">
    <!-- Title -->
    <title>
        koshki Real Estate
    </title>
        ...
        <div class="container-fluid p0">
            ...
            <nav>
                ...
                <div class="menu-toggle">
                    <img class="nav_logo_img img-fluid" src="{{asset("/Content/images/koshkizinewlogo.jpeg")}}" alt="header-logo.png" style="width: 50px">
                ...
                <a href="#" class="navbar_brand ">
                    <img class="logo1 img-fluid" src="{{asset("/Content/images/koshkizinewlogo.jpeg")}}" alt="header-logo.png">
                    <img class="logo2 img-fluid" src="{{asset("/Content/images/koshkizinewlogo.jpeg")}}" alt="header-logo2.png"
                    >
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ul class="sign_up_tab nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">@lang('messages.login')</a>
                                </li>
                        ...
                        <div class="row mt25 tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <div class="col-lg-6 col-xl-6">
                                <div class="login_thumb">
                                    <img class="img-fluid w100" src="/public/Content/images/resource/login.jpg" alt="login.jpg">
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-6">
                        ...
                        <div class="row mt25 tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <div class="col-lg-6 col-xl-6">
                                <div class="regstr_thumb">
                                    <img class="img-fluid w100" src="/public/Content/images/resource/regstr.jpg" alt="regstr.jpg">
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-6">
    ...
    <div id="page" class="stylehome1 h0">
        <div class="mobile-menu">
            <div class="header stylehome1">
                <div class="main_logo_home2 text-center">
                    <img class="nav_logo_img img-fluid mt20" src="/public/Content/images/header-logo2.png" alt="header-logo2.png">
        ...
        <nav id="menu" class="stylehome1">
            <ul>
                ...
                <li><a href="page-login.html"><span class="flaticon-user"></span> @lang('messages.login')</a></li>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="main-title text-center">
                        <h2 class="mt0">  @lang('messages.menu4')</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-xl-5">
                    <div class="about_thumb">
                        <img class="img-fluid w100" src="/public/Content/images/about/1.jpg" alt="1.jpg">
                        {{-- <a class="popup-iframe popup-youtube color-white" href="#"><i class="flaticon-play"></i></a>--}}
                    </div>
                </div>
...
<!-- Wrapper End -->
<script type="text/javascript" src="/public/Content/js/jquery-3.3.1.js"></script>
<script type="text/javascript" src="/public/Content/js/jquery-migrate-3.0.0.min.js"></script>
<script type="text/javascript" src="/public/Content/js/popper.min.js"></script>
<script type="text/javascript" src="/public/Content/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/public/Content/js/jquery.mmenu.all.js"></script>
<script type="text/javascript" src="/public/Content/js/ace-responsive-menu.js"></script>
<script type="text/javascript" src="/public/Content/js/bootstrap-select.min.js"></script>
<script type="text/javascript" src="/public/Content/js/isotop.js"></script>
<script type="text/javascript" src="/public/Content/js/snackbar.min.js"></script>
<script type="text/javascript" src="/public/Content/js/simplebar.js"></script>
<script type="text/javascript" src="/public/Content/js/parallax.js"></script>
<script type="text/javascript" src="/public/Content/js/scrollto.js"></script>
<script type="text/javascript" src="/public/Content/js/jquery-scrolltofixed-min.js"></script>
<script type="text/javascript" src="/public/Content/js/jquery.counterup.js"></script>
<script type="text/javascript" src="/public/Content/js/wow.min.js"></script>
<script type="text/javascript" src="/public/Content/js/progressbar.js"></script>
<script type="text/javascript" src="/public/Content/js/slider.js"></script>
<script type="text/javascript" src="/public/Content/js/timepicker.js"></script>
<!-- Custom script for all pages -->
<script type="text/javascript" src="/public/Content/js/script.js"></script>
<script>
