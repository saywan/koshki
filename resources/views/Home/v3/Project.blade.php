                    ...
                    <div class="breadcrumb_content style2">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active text-thm"
                                aria-current="page"> @lang('messages.Project')</li>
                        </ol>
                        <h2 class="breadcrumb_title"> @lang('messages.Project')</h2>
                    </div>
                </div>
                        ...
                        @foreach($estateInfo as $itemestate)
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="feat_property home7 style4">
                                    <div class="thumb">
                                        {{\App\Helpers\Helper::GetImagesFirstImageVersionPro($itemestate->id)}}
                                        <div class="thmb_cntnt style2">
                                            <ul class="tag mb0">
                                                <li class="list-inline-item">
                                                    <a href="{{url('Project/'.$itemestate->TrackingCode)}}">
                                        ...
                                        <div class="thmb_cntnt style3">
                                            ...
                                            <a class="fp_price" href="{{url('Project/'.$itemestate->TrackingCode)}}">
                                                $
                                                @if($itemestate->advType=='rent')
