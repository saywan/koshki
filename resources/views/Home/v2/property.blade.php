    ...
    <header class="main-header">
        ...
        <div class="header-lower">
            <div class="outer-box">
                <div class="main-box">
                    <div class="logo-box">
                        <figure class="logo"><a href="index.html"><img src="/styleone/images/logo.png" alt=""></a>
                        </figure>
                    </div>
    ...
    <section class="page-title-two bg-color-1 centred">
        ...
        <div class="auto-container">
            <div class="content-box clearfix">
                <h1>Property Details 02</h1>
                <ul class="bread-crumb clearfix">
                    <li><a href="index.html">Home</a></li>
                    <li>Property Details 02</li>
                </ul>
            </div>
        </div>
    </section>
                ...
                <div class="bxslider">
                    <div class="slider-content">
                        <div class="product-image">
                            <figure class="image-box"><img src="/styleone/images/resource/property-details-2.jpg"
                                                           alt=""></figure>
                        </div>
                            ...
                            <ul class="thumb-box clearfix">
                                <li>
                                    <a class="active" data-slide-index="0" href="#">
                                        <figure><img src="/styleone/images/resource/single-thumb-1.jpg" alt=""></figure>
                                    </a>
                                </li>
                                <li>
                                    <a data-slide-index="1" href="#">
                                        <figure><img src="/styleone/images/resource/single-thumb-2.jpg" alt=""></figure>
                                    </a>
                                </li>
                                <li>
                                    <a data-slide-index="2" href="#">
                                        <figure><img src="/styleone/images/resource/single-thumb-3.jpg" alt=""></figure>
                                    </a>
                                </li>
                                <li>
                                    <a data-slide-index="3" href="#">
                                        <figure><img src="/styleone/images/resource/single-thumb-4.jpg" alt=""></figure>
                                    </a>
                                </li>
                                <li>
                                    <a data-slide-index="4" href="#">
                                        <figure><img src="/styleone/images/resource/single-thumb-5.jpg" alt=""></figure>
                                    </a>
                                </li>
                                <li>
                    ...
                    <div class="slider-content">
                        <div class="product-image">
                            <figure class="image-box"><img src="/styleone/images/resource/property-details-3.jpg"
                                                           alt=""></figure>
                        </div>
                        <div class="slider-pager">
                            <ul class="thumb-box clearfix">
                    ...
                    <div class="slider-content">
                        <div class="product-image">
                            <figure class="image-box"><img src="/styleone/images/resource/property-details-4.jpg"
                                                           alt=""></figure>
                        </div>
                        <div class="slider-pager">
                            <ul class="thumb-box clearfix">
                    ...
                    <div class="slider-content">
                        <div class="product-image">
                            <figure class="image-box"><img src="/styleone/images/resource/property-details-5.jpg"
                                                           alt=""></figure>
                        </div>
                        <div class="slider-pager">
                            <ul class="thumb-box clearfix">
                    ...
                    <div class="slider-content">
                        <div class="product-image">
                            <figure class="image-box"><img src="/styleone/images/resource/property-details-6.jpg"
                                                           alt=""></figure>
                        </div>
                        <div class="slider-pager">
                            <ul class="thumb-box clearfix">
                    ...
                    <div class="price-inner clearfix">
                        <ul class="category clearfix pull-left">
                            <li><a href="property-details.html">
                                    {{\App\Helpers\Helper::EstateType($itemestate->EstateTypeId)}}</a></li>
                            <li>
                                <a href="#">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                    <div class="property-details-content">
                        ...
                        <div class="details-box content-widget">
                            <div class="title-box">
                                <h4>@lang('messages.Details')</h4>
                            </div>
                            <ul class="list clearfix">
                                <li>@lang('messages.PropertyID') <span> {{$itemestate->id}}</span></li>
                                <li>@lang('messages.PostedOn'): <span> {{$itemestate->created_at}}</span></li>
                                <li>@lang('messages.Area '): <span>{{$itemestate->created_at}}</span></li>
                                <li>@lang('messages.Price '): <span>
 @if($itemestate->advType=='rent')
                                            @if(empty($itemestate->RentAmount))
                                                {{number_format($itemestate->price_rahan)}}
                                            @else
                                    ...
                                    <div class="acc-content current">
                                        <div class="content-box">
                                            ...
                                            <figure class="image-box">
                                                <img src="/styleone/images/resource/floor-1.png" alt="">
                                            </figure>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="statistics-box content-widget">
                            ...
                            <figure class="image-box">
                                <a href="assets/images/resource/statistics-1.png" class="lightbox-image"
                                   data-fancybox="gallery"><img src="/styleone/images/resource/statistics-1.png" alt=""></a>
                            </figure>
                        </div>
                    ...
                    <div class="property-sidebar default-sidebar">
                        <div class="author-widget sidebar-widget">
                            <div class="author-box">
                                <figure class="author-thumb"><img src="/styleone/images/resource/author-1.jpg" alt="">
                                </figure>
                                <div class="inner">
                                    <h4>Michael Bean</h4>
                                    <ul class="info clearfix">
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                        <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms"
                            ...
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="/styleone/images/feature/feature-1.jpg" alt="">
                                    </figure>
                                    ...
                                    <div class="author-info clearfix">
                                        <div class="author pull-left">
                                            <figure class="author-thumb"><img
                                                    src="/styleone/images/feature/author-1.jpg" alt=""></figure>
                                            <h6>Michael Bean</h6>
                                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                        <div class="feature-block-one wow fadeInUp animated" data-wow-delay="300ms"
                            ...
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="/styleone/images/feature/feature-2.jpg" alt="">
                                    </figure>
                                    <div class="batch"><i class="icon-11"></i></div>
                                    <span class="category">Featured</span>
                                </div>
                                <div class="lower-content">
                                    <div class="author-info clearfix">
                                        <div class="author pull-left">
                                            <figure class="author-thumb"><img
                                                    src="/styleone/images/feature/author-2.jpg" alt=""></figure>
                                            <h6>Robert Niro</h6>
                                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                        <div class="feature-block-one wow fadeInUp animated" data-wow-delay="600ms"
                            ...
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="/styleone/images/feature/feature-3.jpg" alt="">
                                    </figure>
                                    <div class="batch"><i class="icon-11"></i></div>
                                    <span class="category">Featured</span>
                                </div>
                                <div class="lower-content">
                                    <div class="author-info clearfix">
                                        <div class="author pull-left">
                                            <figure class="author-thumb"><img
                                                    src="/styleone/images/feature/author-3.jpg" alt=""></figure>
                                            <h6>Keira Mel</h6>
                                        </div>
                            ...
                            <div class="post-inner">
                                <div class="post">
                                    <figure class="post-thumb"><a href="blog-details.html"><img
                                                src="/styleone/images/resource/footer-post-1.jpg" alt=""></a></figure>
                                    <h5><a href="blog-details.html">The Added Value Social Worker</a></h5>
                                    <p>Mar 25, 2020</p>
                                </div>
                                <div class="post">
                                    <figure class="post-thumb"><a href="blog-details.html"><img
                                                src="/styleone/images/resource/footer-post-2.jpg" alt=""></a></figure>
...
<script src="{{asset("styleone/js/timePicker.js")}}"></script>
<script src="{{asset("styleone/js/bxslider.js")}}"></script>
<script src="{{asset("styleone/js/js?key=AIzaSyA-CE0deH3Jhj6GN4YvdCFZS7DpbXexzGU")}}"></script>
<script src="{{asset("styleone/js/gmaps.js")}}"></script>
<script src="{{asset("styleone/js/map-helper.js")}}"></script>
