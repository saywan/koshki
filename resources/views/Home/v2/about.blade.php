...
@include('Home.v2.Header')
    ...
    <!--Page Title-->
    <section class="page-title centred" style="background-image: url({{asset("styleone/images/background/page-title-3.jpg")}});">
        <div class="auto-container">
            <div class="content-box clearfix">
                <h1>@lang('messages.AboutUs')</h1>
                <ul class="bread-crumb clearfix">

                    <li>@lang('messages.AboutUs')</li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 content-column">
                        <div class="content_block_3">
                            <div class="content-box">
                                <div class="sec-title text-carousel-item text-center">
                                    <h5>@lang('messages.AboutUs')</h5>

                                </div>
                                <div class="text" style="line-height: 50px;text-align: right">
                                    <p>
