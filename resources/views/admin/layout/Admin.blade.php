...
<head>
    ...
    <link href="{{asset("panel/css/css2.css?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;1,400;1,500;1,600")}}" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset("panel/css/plugins/extensions/ext-component-sweet-alerts.min.css")}}">
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img src="{{asset("panel/images//portrait/small/avatar-s-8.jpg")}}" alt="png" height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img src="{{asset("panel/images//portrait/small/avatar-s-1.jpg")}}" alt="png" height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img src="{{asset("panel/images//portrait/small/avatar-s-14.jpg")}}" alt="png" height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img src="{{asset("panel/images//portrait/small/avatar-s-6.jpg")}}" alt="png" height="32"></div>
                <div class="search-data">
...
<footer class="footer footer-static footer-light">
    <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT  &copy; 2022<a class="ms-25" href="#" target="_blank">

            </a><span class="d-none d-sm-inline-block">, All rights Reserved</span></span><span class="float-md-end d-none d-md-block">
