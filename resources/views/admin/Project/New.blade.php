                    ...
                    <div class="card-body">
                        ...
                        <div id="wizard2">
                            ...
                            <section class="card card-body border mb-0">
                                <h5>
                                    @lang('messages.BasicInformationProject')
                                </h5>

                                <form id="form1">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            <label> @lang('messages.ProjectNameen') *</label>
                                            <input type="text" name="projectTitleen"
                                                   id="projectTitleen" class="form-control"
                                                   placeholder=" @lang('messages.ProjectNameen')" required>
                                            <div class="valid-feedback">
                                                Correct !
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label> @lang('messages.ProjectName') *</label>
                                            <input type="text" name="projectTitle"
                                                   id="projectTitle" class="form-control"
                                                   placeholder=" @lang('messages.ProjectName')" required>
                                            <div class="valid-feedback">
                                                Correct !
                                            </div>
                                        </div>
...
@section('scripts')
    ...
    <script src="{{asset("panel/js/form-wizard2.js")}}"></script>
