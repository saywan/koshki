                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                        ...
                                        <i class="ti-trash"></i>
                                                    ...
                                                    <a href="{{url('admin/Project/edit/'.$itemtyoe->id)}}"   class="btn btn-success btn-floating" data-container="body" data-toggle="tooltip" data-placement="top" data-toggle="tooltip" data-original-title=" مشاهده اطلاعات ملک " aria-describedby="popover116211">
