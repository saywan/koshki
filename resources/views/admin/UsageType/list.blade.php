                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <button v-on:click="DeleteUsageType({{$itemregion->id}})" type="button" class="btn btn-danger btn-floating" data-container="body" data-toggle="tooltip" data-original-title="حذف"  data-placement="top"  data-original-title="" title="" aria-describedby="popover116211">
                                                                <i data-feather='trash'></i>

                                                            </button>


                                                        <!--                                                    <a href="#"  v-on:click="DeleteUsageType({{$itemregion->id}})" class="btn btn-danger shadow btn-xs sharp">
