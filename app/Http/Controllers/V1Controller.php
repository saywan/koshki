...
class V1Controller extends Controller
{
    public function index()
    {
        ...
        return view('Home.v1.index', ['estate' => $estateinfo, 'setting' => $setting, 'region' => $region, 'estateVIP' => $estateVIP, 'estatePresell' => $estatePresell]);
    }
    ...
    public function contactus()
    {
        ...
        return view('Home.v1.contactus');
    }

    public function EstateRequest()
    {

        return view('Home.v1.EstateRequest');
    }
    ...
    public function EstateProperty($trackcode)
    {
        ...
        return view('Home.v1.property', ['itemestate' => $estateinfo]);
    }
    ...
    public function getProperties($typeadv)
    {
        ...
        $setting = AdminSettings::find(1);
        return view('Home.v1.Properties', ['estateInfo' => $estateInfo, 'type' => $typeadv, 'setting' => $setting]);
    }
}
