$((function () {
    ...
    "laravel" === $("body").attr("data-framework") && (o = $("body").attr("data-asset-path"), r = o + "admin/Estate"), s.each((function () {
        var e = $(this);
        ...
        ajax: o + "Estate",
        columns: [{data: "id"}, {data: "full_name"}, {data: "role"}, {data: "current_plan"}, {data: "billing"}, {data: "status"}, {data: ""}],
        columnDefs: [{
            className: "control",
            orderable: !1,
