$((function () {
    ...
    var e = document.querySelectorAll(".bs-stepper"), n = $(".select2"),
        ...
        r = document.querySelector(".vertical-wizard-example"), t = document.querySelector(".modern-wizard-example"),
    ...
    if (n.each((function () {
        ...
        $(i).find("form").each((function () {
            ...
            $(this).parent().siblings("form").valid() && alert("Submi66666666666666stted..!!")
        }))
    }
